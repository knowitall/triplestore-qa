JAVA_OPTS=-Xmx16g ./target/start \
    ...
    eval/qa/output/debra-2014-02-08-172453-model.1.avg.txt-webquestions.test-notemplates
...
JAVA_OPTS=-Xmx16g ./target/start \
    ...
    edu.knowitall.eval.qa.QASystemRunner \
    eval/qa/questions/webquestions.test.txt \
    eval/qa/output/debra-2014-02-08-172453-model.1.avg.txt-webquestions.test-norelsyn
...
JAVA_OPTS=-Xmx16g ./target/start \
    ...
    edu.knowitall.eval.qa.QASystemRunner \
    eval/qa/questions/webquestions.test.txt \
    eval/qa/output/debra-2014-02-08-172453-model.1.avg.txt-webquestions.test-defaultWeights
...
JAVA_OPTS=-Xmx16g ./target/start \
    ...
    edu.knowitall.eval.qa.QASystemRunner \
    eval/qa/questions/webquestions.test.txt \
    eval/qa/output/debra-2014-02-08-172453-model.1.avg.txt-webquestions.test-maxconj1
...
JAVA_OPTS=-Xmx16g ./target/start \
    ...
    edu.knowitall.eval.qa.QASystemRunner \
    eval/qa/questions/webquestions.test.txt \
    eval/qa/output/debra-2014-02-08-172453-model.1.avg.txt-webquestions.test-noopenie
...
JAVA_OPTS=-Xmx16g ./target/start \
    ...
    edu.knowitall.eval.qa.QASystemRunner \
    eval/qa/questions/webquestions.test.txt \
    eval/qa/output/debra-2014-02-08-172453-model.1.avg.txt-webquestions.test-nofreebase
...
JAVA_OPTS=-Xmx16g ./target/start \
    ...
    edu.knowitall.eval.qa.QASystemRunner \
    eval/qa/questions/webquestions.test.txt \
    eval/qa/output/debra-2014-02-08-172453-model.1.avg.txt-webquestions.test-noprobase
...
JAVA_OPTS=-Xmx16g ./target/start \
    ...
    edu.knowitall.eval.qa.QASystemRunner \
    eval/qa/questions/webquestions.test.txt \
    eval/qa/output/debra-2014-02-08-172453-model.1.avg.txt-webquestions.test-nonell
