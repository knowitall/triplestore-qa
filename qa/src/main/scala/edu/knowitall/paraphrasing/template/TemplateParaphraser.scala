...
case class TemplateParaphraser(scorer: TemplateParaphraseScorer, generator: TemplateParaphraseGenerator) extends Paraphraser {
  
  def this() = this(new TemplateParaphraseScorer(), new SolrParaphraseGenerator())
