...
//    val qo = ParseOrdering.compare(a.etuple.query, b.etuple.query)
//
...
//
//    override def compare(aq: String, a: ConjunctiveQuery, bq: String, b: ConjunctiveQuery): Int = {
//      // is it paraphrased?
//      val ap = aq != originalQuestion
//      val bp = bq != originalQuestion
//
